...
(function (root, factory) {
  ...
  var Circles = function (options) {
    ...
    } else if (typeof options.el !== 'undefined' && options.el !== null) {
      this._el = options.el
    }
  ...
  Circles.prototype = {
    ...
    _getText: function (value) {
      ...
      return typeof this._text === 'function' ? this._text(this, value) : this._text
    },
    ...
    _calculatePath: function (percentage, open) {
      ...
      var endPrecise = this._precise(end)
      return this._arc(endPrecise, open)
    },

    _arc: function (end, open) {
      var endAdjusted = end - 0.001
      var longArc = end - this._startPrecise < Math.PI ? 0 : 1
    ...
    htmlifyNumber: function (number, integerPartClass, decimalPartClass) {
      ...
      var html = '<span class="' + integerPartClass + '">' + parts[0] + '</span>'
    ...
    update: function (value, duration) {
      ...
      var self = this
      var oldPercentage = self.getPercent()
      var delta = 1
      var newPercentage
      var isGreater
      var steps
